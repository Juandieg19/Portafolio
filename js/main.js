...
const translations = {
  es: {
    ...
    'about.p1':     'Soy Juan Diego, apasionado por construir tecnología que resuelve problemas reales. Desde automatizar procesos operativos en PYMES hasta entrenar redes neuronales para controlar neuroprótesis, me impulsa el impacto tangible que la tecnología puede generar en la vida cotidiana.',
    'about.p2':     'Trabajo con Python, Flask, Machine Learning y sistemas embebidos, construyendo soluciones funcionales y de alto impacto. Me caracterizo por comunicarme con claridad tanto con equipos técnicos como con clientes sin perfil tecnológico, aprender rápido en entornos cambiantes y no dar un proyecto por terminado hasta que funcione bien para quien lo va a usar.',
    ...
    'proj.p1.desc':  'Los sistemas de control para neuroprótesis dependían de reglas manuales sin capacidad de aprendizaje. Diseñé y entrené una red neuronal capaz de clasificar patrones de movimiento en tres categorías, construyendo el dataset desde cero, optimizando la arquitectura del modelo y desplegándolo en hardware embebido de bajo cómputo, logrando un sistema de control inteligente funcional en tiempo real.',
    'proj.p1.m1':    'Accuracy',
    'proj.p1.m2':    'Clases',
    'proj.p1.m3':    'F1 Score',
  ...
  en: {
    ...
    'about.p1':     'I\'m Juan Diego, passionate about building technology that solves real problems. From automating operational processes in SMEs to training neural networks to control neuroprostheses, I\'m driven by the tangible impact technology can have on everyday life.',
    'about.p2':     'I work with Python, Flask, Machine Learning and embedded systems, building functional and high-impact solutions. I communicate clearly with both technical teams and non-technical clients, learn quickly in changing environments, and never consider a project done until it works well for the person using it.',
    ...
    'proj.p1.desc':  'Neuroprosthesis control systems relied on manual rules with no learning capability. I designed and trained a neural network to classify movement patterns into three categories, building the dataset from scratch, optimizing the model architecture and deploying it on low-compute embedded hardware, achieving a functional real-time intelligent control system.',
    'proj.p1.m1':    'Accuracy',
    'proj.p1.m2':    'Classes',
    'proj.p1.m3':    'F1 Score',
